<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $desc = $_POST['desc'];
        $sql = "INSERT INTO project (roll_no, description) VALUES ('$rollno', '$desc')";
...
<div class="container">
    ...
    <div id="miniProjectsContainer">
        <div class="mini-project">
            <label for="projectDescription">Name and Description</label>
            <textarea id="projectDescription1" name="desc" required></textarea>
        </div>
    </div>
