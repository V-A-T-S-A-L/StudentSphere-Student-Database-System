<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $desc = $_POST['desc'];
        $sql = "INSERT INTO patent (roll_no, description) VALUES ('$rollno', '$desc')";
...
<div class="container">
    ...
    <div id="patentsContainer">
        <div class="patent">
            <label for="patentDescription">Name and Description</label>
            <textarea id="patentDescription1" name="desc" required></textarea>
        </div>
    </div>
